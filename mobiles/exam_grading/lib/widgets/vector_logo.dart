...
class _ChecklistLogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      // Line 1
      canvas.drawLine(Offset(w * 0.35, y), Offset(w * 0.55, y), paintBlack..strokeWidth = w * 0.03);
      // Line 2 (indented)
      canvas.drawLine(Offset(w * 0.35, y + h * 0.06), Offset(w * 0.48, y + h * 0.06), paintBlack);
    }
    ...
    canvas.drawCircle(Offset(w * 0.75, h * 0.75), w * 0.25, paintBlack..strokeWidth = w * 0.04);
