      ...
      {exam ? (
        <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 2xl:columns-5 gap-4">
          {questionNumbers.map((question) => (
            <div key={question} className="break-inside-avoid bg-white rounded-xl border border-zinc-200 p-4 flex items-center justify-between mb-4 hover:border-indigo-300 transition-colors ">
        ...
        <div className="bg-white border border-zinc-200 rounded-2xl p-10 text-center text-zinc-500 ">เลือกข้อสอบเพื่อกำหนดเฉลย</div>
      )}
    </div>
  );
}
